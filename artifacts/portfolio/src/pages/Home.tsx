    ...
    <PageTransition>
      <div className="min-h-[calc(100dvh-4rem)] flex flex-col justify-center items-center text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center gap-8">
          ...
          >
            <img src="/profile.png" alt="Ochieng Malvine Odallo" className="w-full h-full object-cover" />
          </motion.div>
          ...
          <div className="space-y-4">
            ...
            >
              OCHIENG MALVINE <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-cyan-400">ODALLO</span>
            </motion.h1>
            <motion.h2 
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              Student Forensic Scientist | Student Leader
            </motion.h2>
            <motion.p 
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            >
              "Driving community impact through leadership, service, and innovation."
            </motion.p>
          </div>
          ...
          >
            ...
            <a href="/Ochieng_Malvine_Odallo_CV.pdf" download="Ochieng_Malvine_Odallo_CV.pdf" data-testid="button-download-cv" className="inline-flex h-12 items-center justify-center rounded-md border border-input bg-background px-8 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50">
              Download CV
            </a>
          </motion.div>
        </div>
