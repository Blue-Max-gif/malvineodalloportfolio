...
const experiences = [
  {
    role: "CEO",
    organization: "Uplift Society",
    bullets: [
      "Leading community empowerment programs",
      "Strategic planning, team coordination, resource mobilization",
    ]
  },
  {
    role: "Organizing Secretary",
    organization: "NUSA (Nyakach University Students Association)",
    bullets: [
      "Event coordination",
      "Student engagement",
